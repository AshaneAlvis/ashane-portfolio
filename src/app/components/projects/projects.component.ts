              ...
              <div class="relative z-10">
                ...
                <div class="flex gap-3 mt-auto">
                  <a *ngIf="project.githubUrl" [href]="project.githubUrl" target="_blank" 
                     class="group/btn inline-flex items-center gap-2 px-5 py-2.5 border-2 border-primary-700 text-primary-700 rounded-xl font-semibold hover:bg-gradient-to-r hover:from-primary-50 hover:to-primary-100 transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 active:scale-95">
  ...
  projects: Project[] = [
    {
      ...
      description: 'A modern, responsive portfolio website built with Angular and Angular Material, showcasing my projects and skills.',
